            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <div style={{ backgroundColor: colors.bgPrimary }} className="rounded-2xl p-4 sm:p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="space-y-2">
                            <button style={{ backgroundColor: colors.bgAccent, color: colors.purple }} className="w-full text-left py-2 px-3 rounded-lg font-medium">
                                Account Settings
                            </button>
                            <button style={{ color: colors.textSecondary }} className="w-full text-left py-2 px-3 rounded-lg hover:bg-opacity-80 transition-colors">
                                Notifications
                            </button>
                            <button style={{ color: colors.textSecondary }} className="w-full text-left py-2 px-3 rounded-lg hover:bg-opacity-80 transition-colors">
                                Privacy & Security
                ...
                >
                    <div style={{ backgroundColor: colors.bgPrimary }} className="rounded-2xl p-4 sm:p-6 md:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="mb-8">
                            <h2 style={{ color: colors.textPrimary }} className="text-xl font-bold mb-4">Account Settings</h2>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div style={{ backgroundColor: colors.bgSecondary }} className="p-4 rounded-xl">
                                    <h3 style={{ color: colors.textPrimary }} className="font-medium mb-3">Notifications</h3>

                                    <div className="flex items-center justify-between mb-2">
                                        <p style={{ color: colors.textSecondary }} className="text-sm">Email Notifications</p>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
                                                className="sr-only peer"
                                    ...
                                    <div className="flex items-center justify-between">
                                        <p style={{ color: colors.textSecondary }} className="text-sm">App Notifications</p>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
                                                className="sr-only peer"
