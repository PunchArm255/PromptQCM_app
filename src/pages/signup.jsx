...
export const SignUp = () => {
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="min-h-screen flex flex-col items-center justify-center bg-[#EAEFFB] px-4"
        >
            <motion.div
            ...
            <motion.div
                ...
                className="w-full max-w-md bg-[#F5F6FF] rounded-2xl p-10 shadow-[0_10px_50px_rgba(0,0,0,0.1)] relative overflow-hidden"
            >
                ...
                <h1 className="text-3xl font-bold text-center mb-2 text-[#252525]">Get Started!</h1>
